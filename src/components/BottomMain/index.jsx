      ...
      <div className="row">
        <div className="col-lg-3 col ml-auto large-holder">
          <div className="row">
            ...
            <div className="col-auto mr-auto large-text">Best Price</div>
          </div>
        </div>
        <div className="col-lg-3 col large-holder">
          <div className="row">
            ...
            <div className="col-auto mr-auto large-text">Fast Delivery</div>
          </div>
        </div>
        <div className="col-lg-3 col mr-auto large-holder">
          <div className="row">
            ...
            <div className="col-auto mr-auto large-text">Genuine Products</div>
          </div>
        </div>
      </div>
    </div>
